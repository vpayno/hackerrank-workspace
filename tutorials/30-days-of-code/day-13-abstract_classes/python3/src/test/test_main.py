...
def test_method_without_input(data: List[str], expected: List[str], capsys):
...
@pytest.mark.parametrize("data,expected", unit_test_data)
def test_method_with_input(data: List[str], expected: List[str], capsys):
...
@pytest.mark.parametrize("data,expected", unit_test_data)
def test_script(data: List[str], expected: List[str]):
